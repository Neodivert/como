...
TextureCommand::TextureCommand( const ResourceID& textureID, TextureCommandType commandType ) :
    TypeCommand( CommandTarget::TEXTURE, commandType, textureID.getCreatorID() )
{
